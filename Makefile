...
SERVICE_LOGGER_CLASS ?= nope
SERVICE_LOGGER_DB_HOST ?= localhost
SERVICE_LOGGER_DB_PORT ?= 5432
SERVICE_LOGGER_DB_USER ?= postgres
SERVICE_LOGGER_DB_PASS ?= password
SERVICE_LOGGER_DB_DATABASE ?= pyramid_oereb_metrics
SERVICE_LOGGER_SQLALCHEMY_URL ?= "postgresql://$(SERVICE_LOGGER_DB_USER)@$(SERVICE_LOGGER_DB_HOST):$(SERVICE_LOGGER_DB_PORT)/$(SERVICE_LOGGER_DB_DATABASE)"
